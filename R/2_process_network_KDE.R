...
bikemaps <- read_sf("input/processed/inc_bm_snp_30m.gpkg")
network <- read_sf("input/processed/edge_ec_total_crash_strava.gpkg")
list_list_10m <- load("input/processed/lixel_list_edge_ec_total_crash_strava.RData")
...
write_sf(bm_network_kde$network_kde,"output/bikemaps_network_kde_10m_lixel_50m_250m_bw.gpkg")
...
write_sf(exp_network_kde$network_kde,"output/strava_network_kde_10m_lixel_50m_250m_bw.gpkg")
#write nearest neighbour list to .RData
